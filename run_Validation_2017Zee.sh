...
./heppi-draw -p plotcard2017_zee.json -o "/eos/user/z/zhenxuan/Hgg_mass/Zee/Plots/" -s "/eos/user/z/zhenxuan/Hgg_mass/Zee/" -t {sampleid}_13TeV_UntaggedTag --label zee -v diphoMVA
